...
public class CraftingManager {
    ...
    public void registerRecipe(int protocol, Recipe recipe) {
        if (recipe instanceof FurnaceRecipe) {  // FurnaceRecipe implements SmeltingRecipe
            this.registerFurnaceRecipe(protocol, (FurnaceRecipe) recipe);
        } else if (recipe instanceof SmithingRecipe) {
            this.registerSmithingRecipe(protocol, (SmithingRecipe) recipe);
