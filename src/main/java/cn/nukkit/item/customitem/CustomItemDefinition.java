...
public class CustomItemDefinition {
    ...
    public static class ToolBuilder extends SimpleBuilder {
        ...
        public CustomItemDefinition build() {
            ...
            if (item.isPickaxe()) {
                //添加可挖掘方块Tags
                this.blockTags.addAll(Arrays.asList("'stone'", "'metal'", "'diamond_pick_diggable'", "'mob_spawner'", "'rail'", "'slab_block'", "'stair_block'", "'smooth stone slab'", "'sandstone slab'", "'cobblestone slab'", "'brick slab'", "'stone bricks slab'", "'quartz slab'", "'nether brick slab'", "'glazed terracotta'", "coral"));
                //添加可挖掘方块
